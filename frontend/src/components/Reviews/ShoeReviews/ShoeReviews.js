...
function ShoeReviews ({ shoe }) {
  ...
  const defaultImage = <img src={shoe?.image} className='review-image' alt='default shoe' />
  const defaultImageNoEdit = <img src={shoe?.image} className='review-image-noEdit' alt='default shoe' />
